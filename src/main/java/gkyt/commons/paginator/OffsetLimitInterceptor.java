package gkyt.commons.paginator;
...
import gkyt.commons.paginator.dialect.Dialect;
import gkyt.commons.paginator.domain.PageBounds;
import gkyt.commons.paginator.domain.PageList;
import gkyt.commons.paginator.domain.Paginator;
import gkyt.commons.paginator.support.PropertiesHelper;
import gkyt.commons.paginator.support.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor{
	private static final Logger logger = Logger.getLogger(OffsetLimitInterceptor.class);
